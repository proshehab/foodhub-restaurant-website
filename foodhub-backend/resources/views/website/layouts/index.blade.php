...
@section('content')
    ...
    <section class="home" id="home">
        ...
        <div class="home-right">
            ...
            <img src="{{ asset('website/assets/images/circle.svg') }}" alt="circle shape" class="shape shape-3"
                width="30">
            <img src="{{ asset('website/assets/images/ring.svg') }}" alt="ring shape" class="shape shape-4" width="60">
            <img src="{{ asset('website/assets/images/ring.svg') }}" alt="ring shape" class="shape shape-5" width="40">
    ...
    <section class="about" id="about">
        ...
        <div class="about-right">
            ...
            <img src="{{ asset('website/assets/images/signature.png') }}" alt="signature" class="signature" width="150">
